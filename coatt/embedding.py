...
class PretrainedTextEmbedding:
    def __init__(self, embed_dim=None, device='cuda:1', **kwargs):
        self.embed_dim = embed_dim
        self.embed_layer = None
        self.device = torch.device(device)

    @staticmethod
    def from_pretrained(pretrained_name, embed_dim=None, pretrained_root=None, device='cuda:1'):
...
class PretrainedW2VEmbedding(PretrainedTextEmbedding):
    ...
    def __init__(self, pretrained_name, pretrained_root, embed_dim=None, device='cuda:1', **kwargs):
