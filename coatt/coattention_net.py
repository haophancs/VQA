...
from coatt.embedding import PretrainedTextEmbedding
...
class CoattentionNet(nn.Module):
    ...
    """
    def __init__(self, num_embeddings, num_classes, embed_dim=512, k=30, pretrained_embed='word2vec_vi_words_100dims'):
        super().__init__()
