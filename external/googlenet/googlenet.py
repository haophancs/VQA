...
class GoogLeNet(nn.Module):
    ...
    def __init__(self, num_classes=1000, aux_logits=True, transform_input=False,
        ...
        self.conv1 = BasicConv2d(3, 16, kernel_size=7, stride=2, padding=3)
        self.maxpool1 = nn.MaxPool2d(3, stride=2, ceil_mode=True)
        self.conv2 = BasicConv2d(16, 16, kernel_size=1)
        self.conv3 = BasicConv2d(16, 192, kernel_size=3, padding=1)
        self.maxpool2 = nn.MaxPool2d(3, stride=2, ceil_mode=True)

        self.inception3a = Inception(192, 16, 96, 128, 16, 32, 32)
        self.inception3b = Inception(256, 128, 128, 192, 32, 96, 16)
        self.maxpool3 = nn.MaxPool2d(3, stride=2, ceil_mode=True)

        self.inception4a = Inception(480, 192, 96, 208, 16, 48, 16)
        self.inception4b = Inception(512, 160, 112, 480, 24, 16, 16)
    ...
    def forward(self, x):
        if self.transform_input:
            ...
            x_ch1 = torch.unsqueeze(x[:, 1], 1) * (0.480 / 0.5) + (0.456 - 0.5) / 0.5
